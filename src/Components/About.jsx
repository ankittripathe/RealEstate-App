        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-start md:gap-5 lg:gap-20">
          ...
          <div className="flex flex-col items-center  md:items-start mt-10 text-gray-600">
            ...
            <p className="my-6 max-w-lg">
              ...
              projects and delivered 20+ million square feet of property, with
              25+ ongoing projects that reflect our commitment to quality and
              client satisfaction. At our company, we believe in turning your
              dreams into reality. Our dedicated team works closely with you to
              understand your vision and ensure that every detail aligns with
              your goals. Let us help you find your perfect property!
            </p>
